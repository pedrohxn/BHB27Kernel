...
KBUILD_CFLAGS	+= -mcpu=cortex-a15 -mtune=cortex-a15 -Ofast

# not tested
#-s -pipe  -mfloat-abi=soft -mfpu=vfpv4 -fno-tree-vectorize -fmodulo-sched -fmodulo-sched-allow-regmoves -fno-inline-functions -funroll-loops
